...
// number 15
console.table(itCompanies.sort())

// number 16
console.table(itCompanies.reverse())
...
console.table(itCompanies.length = [])
...
// import {webTechs} from "..scripts/webTechs.js"
...
const finisedWord = word.split(" ")
console.log(finisedWord)
console.log(finisedWord.length)

// number 3
const shoppingCart = ['Milk', 'Coffee', 'Tea','Honey']

const meat = shoppingCart.unshift('meat')
const sugar = shoppingCart.push('sugar')
const honey = shoppingCart.pop('Honey')
// console.log(meat)
// console.log(honey)
// console.log(sugar)
